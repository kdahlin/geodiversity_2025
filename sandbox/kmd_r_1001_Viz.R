...
ORNL <- "./processed_tifs/ORNL_2018_DEM_mosaic_2025-11-14_1_1m.tif"
CPER <- "./processed_tifs/CPER/CPER_2020_DEM_mosaic_2025-11-14_9_1m.tif"
RMNP <- "./processed_tifs/RMNP/RMNP_2020_DEM_mosaic_2025-11-14_2_1m.tif"
WOOD <- "./processed_tifs/WOOD_2020_DEM_mosaic_20251005.tif"
...
metric.small <- subset(Metrics_LongRes_top, Metrics_LongRes_top$metrics == "Range")

ggplot(metric.small, aes(x = raster_id, y = value, color = raster_id, shape = Tile)) +
  geom_beeswarm(size=3) +
  theme_bw() +
  scale_color_manual(values = c("CPER" = "aquamarine4", "OAES" = "aquamarine4", "CLBJ" = "aquamarine4", 
                                "ORNL" = "royalblue4", "MLBS" = "royalblue4", 
                                "RMNP"="purple3", "TEAK"="purple3", "WREF"="purple3", 
                                "WOOD"="darkorange3", "OSBS"="darkorange3", "UNDE"="darkorange3"), guide="none") +
  scale_shape_manual(name = "Subsite",
                     values = c("1" = 1, "2" = 2, "3" = 0, "4" = 5, "5" = 16, "6" = 17, "7" = 18, "8" = 15, "9" = 4))+
  labs(x = "", y = "", title = "Range") +
